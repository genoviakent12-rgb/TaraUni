...
public class CarpoolsController {
  ...
  //adds carpool
  @PostMapping("/{id}")
  public ResponseEntity<Carpools> addCarpool(@RequestBody Carpools carpool) {
  ...
  //join carpool
  @PostMapping("/{id}/join")
  public ResponseEntity<Carpools> joinCarpool(@PathVariable Long id) {
  ...
  //deletes carpool
  @DeleteMapping("/{id}")
  public ResponseEntity<Carpools> deleteCarpool(@PathVariable Long id) {
