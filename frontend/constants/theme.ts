export const Colors = { 
  ...
  textSecondary: '#343434ac',    // deeper teal — more legible than the near-pastel original
  surface: '#fbfbfbff',          // mint, very close to your original, kept as the anchor tone
